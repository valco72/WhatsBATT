...
if (Config.WORKTYPE == 'private') {
    ...
    BAT.addCommand({pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC}, (async (message, match) => {
    ...
    BAT.addCommand({pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC, dontAddCommandList: true}, (async (message, match) => {
